...
export default function Section() {
  return (
    ...
    <section className="about">
        ...
        <img className='jonImg'src="../assets/JonathonPic.jpg" alt="Jonathon Image"/>
    </section>
        ...
        <section className="projectCards">
            <section id="calc">
                ...
                <a href="https://blomjonathon.github.io/deployedjscalc/" target="_blank">
                    <img src="./assets/images/jscalc.png" alt="calculator Image" />
                </a>
            </section>
            <section>
                <h3>Weather API</h3>
                <a href="https://blomjonathon.github.io/deployedweatherapi/" target="_blank">
                    <img src="./assets/images/weatherapp.png" alt="calculator Image" />
                </a>
            </section>
            <section>
                <h3>Coming Soon</h3>
                <img id="firstSoonImg" src="./assets/images/comingsoon.jpg" alt="coming soon Image" />
            </section>
        </section>
    </>
  );
